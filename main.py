...
def get_amazon_suggestions(keyword, alias="aps"):
    r = safe_get(
        ...
        {"mid": "ATVPDKIKX0DER", "alias": alias,
         "prefix": keyword, "suggestionType": "KEYWORD"},
        "Amazon"
    )
    if r:
        try:
...
{{
    ...
    return {
        ...
        "unique_angle": f"Designed around the top complaint from 500+ verified buyer reviews",
...
def run_phase4(platform_key, platform_cfg):
    ...
    return {
        ...
        "stressed_margin": round(stressed_margin * 100, 1),
...
def main():
    ...
    with st.sidebar:
        ...
        <b style="color:#E8F4FF">COST</b><br>
        $0 — all free sources<br><br>
